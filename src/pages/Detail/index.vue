        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dt class="title">{{spuSaleAttr.sale.AttrName}}</dt>
                <dd changepirce="0" :class="{active:spuSaleAttrValue.isChecked}" v-for="(spuSaleAttrValue,index) in spuSaleAttr.spuSaleAttrValueList" :key="spuSaleAttrValue.id"
                @click="changeActive">
